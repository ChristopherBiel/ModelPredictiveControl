...
# # Example from Lecture notes Chapter 5
...
# Cx = np.array([[1, 0], [0, 1], [-1, 0], [0, -1]])
# cx = np.array([[5], [5], [5], [5]])
# xCstrSet = pc.Polytope(Cx, cx)
# Cu = np.array([[1], [-1]])
# cu = np.array([[0.5], [0.5]])
# uCstrSet = pc.Polytope(Cu, cu)


# # Example from Lecture 7
# A = np.array([[1.5, -0.9], [1.0, 0.0]])
# B = np.array([[1.0], [0.0]])
# Cx = np.array([[1, 0], [0, 1], [-1, 0], [0, -1]])
# cx = np.array([[1], [1], [1], [1]])
# xCstrSet = pc.Polytope(Cx, cx)
...
# cu = np.array([[1], [1]])
# uCstrSet = pc.Polytope(Cu, cu)
# S = ctrlInvSet(A, B, xCstrSet, uCstrSet)

# # Example from Lecture notes Chapter 2
# # A = np.array([[0.923, 0.063],[-1.554, 0.296]])
# # B = np.array([[0.1],[1]])
# # Cx = np.array([[1,0],[0, 1], [-1, 0], [0, -1]])
# # cx = np.array([[1],[1],[1],[1]])
# # xCstrSet = pc.Polytope(Cx,cx)
...
# # S = LQRSet(A, B, Q, R, xCstrSet, uCstrSet)
# # print(S)
# S.plot()
# plt.pyplot.xlim(-4, 4)
# plt.pyplot.ylim(-1.5, 1.5)
# plt.pyplot.show()
